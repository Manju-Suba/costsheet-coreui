...
const Tables = () => {
  ...
  const [issapCode, setdisabled] = useState(false)
  const [isnotsap, setdisablesap] = useState(false)

  const addRow = () => {
    setTableData([...tableData, { sap_code: '', ingredient: '', rate: '', qty: '', scrap: '' }])
  }
  ...
  const disableInput = (index, event) => {
    const { name, value } = event.target
    console.log(value)
    if (name == 'sap_code' && value != '') {
      setdisabled(true)
    } else {
      setdisabled(false)
    }
  }
  const disablesap = (index, event) => {
    const { name, value } = event.target
    console.log(value)
    if (name == 'ingerdient' && value != '') {
      setdisablesap(true)
    } else {
      setdisablesap(false)
    }
        ...
        <div>
          <button
            ...
            onClick={() => {
              ...
              setTableData([
                ...tableData,
                { sap_code: '', ingredient: '', rate: '', qty: '', scrap: '' },
              ])
            }}
          >
            Add
                ...
                <CTable className="striped bordered">
                  <CTableHead>
                    <CTableRow>
                      ...
                      <CTableHeaderCell style={{ width: '20%' }}>Ingerdient</CTableHeaderCell>
                      ...
                      <CTableRow key={index}>
                        <CTableDataCell>
                          <CFormInput
                            ...
                            onKeyUp={(e) => disableInput(index, e)}
                            disabled={isnotsap}
                            required
                          />
                        </CTableDataCell>
                        <CTableDataCell>
                          <CFormInput
                            type="text"
                            name="ingerdient"
                            value={row.ingerdient}
                            onChange={(e) => handleInputChange(index, e)}
                            onKeyUp={(e) => disablesap(index, e)}
                            disabled={issapCode}
                          />
                        </CTableDataCell>
                        <CTableDataCell>
